...
public class PageDealPassword {
	...
	public void setPwd() throws InterruptedException{
		...
		vcan.clickByIdAndInput("com.sht.smartcommunity:id/initialize_name_et", "证件名");
		vcan.clickByIdAndInput("com.sht.smartcommunity:id/initialize_card_et", "证件号");
		
		vcan.InputPassWord("com.sht.smartcommunity:id/edtTxt_pwd");//首次密码
		vcan.InputPassWord("com.sht.smartcommunity:id/edtTxt_pwd_sure");//确认首次密码
...
//		vcan.InputPayPassWord("com.sht.smartcommunity:id/edtTxt_pwd_old");
		vcan.InputNewPayPassWord("com.sht.smartcommunity:id/edtTxt_pwd_old");//故意把新密码当旧密码输入
	...
	public void forgetPwd() throws InterruptedException{
		...
		Thread.sleep(9000);
		vcan.clickByIdAndInput("com.sht.smartcommunity:id/forget_bankcard_et", "42058119920325003X");
